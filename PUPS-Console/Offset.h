...
namespace offset {
	...
	namespace signature {
		...
		const DWORD dwEntityList = 0x4D5022C;
		...
		const DWORD dwForceJump = 0x51ED488;
		...
		const DWORD set_abs_angles = 0x1D52D0;
		const DWORD set_abs_origin = 0x1D5110;
	}
}